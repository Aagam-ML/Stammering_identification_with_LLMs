...
def main():
    file_path = '/Volumes/HDD/Stammering_identification/Stammering_identification_with_LLMs/Practical/BERT/bert_features_3.pt'
    ...
    # Step 4: Initialize and train the multi-label model using XGBoost
    model = MultiOutputClassifier(XGBClassifier(n_estimators=100, random_state=42, use_label_encoder=False, eval_metric='logloss'))
